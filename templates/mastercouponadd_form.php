<form action="mastercouponadd.php" method="post">
    <fieldset>
        <div class="form-group">
            ...
            <input class="form-control" name="validfrom" placeholder="Valid from Date format yyyy-mm-dd" type="date"/>
            <input class="form-control" name="validthru" placeholder="Valid thru Date format yyyy-mm-dd" type="date"/>
